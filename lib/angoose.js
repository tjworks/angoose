...
//, storageFactory = require('continuation-local-storage');
...
function getContext(){
    ...
    if(!domain.active || !domain.active.context) throw "Context not available. This may happen if the code was not originated by Angoose";
