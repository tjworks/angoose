...
function harvestModules(options){
    ...
    var extensionFiles = _.map(extensions, function(ext){
        if(typeof(ext) == "string" && fs.existsSync(path.resolve(__dirname,  "../extensions/"+ ext+".js"))){
...
function config(conf){
    ...
    if(!angoose.initialized && typeof(conf) == 'string') throw "Cannot call config() before angoose is intialized";
